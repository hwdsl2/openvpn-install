...
使用 Linux 腳本一鍵快速架設自己的 OpenVPN 伺服器。支援 Ubuntu、Debian、AlmaLinux、Rocky Linux、CentOS、Fedora、openSUSE、Amazon Linux 和 Raspberry Pi OS。
...
- 書籍：[Privacy Tools in the Age of AI](docs/vpn-book-zh-Hant.md#新privacy-tools-in-the-age-of-ai)、[架設自己的 VPN 伺服器](docs/vpn-book-zh-Hant.md#架設自己的-vpn-伺服器ipsec-vpnopenvpn-與-wireguard-實作指南)
...
> [!TIP]
> 你可以選擇在同一台伺服器上安裝 [WireGuard](https://github.com/hwdsl2/wireguard-install/blob/master/README-zh-Hant.md)、[IPsec VPN](https://github.com/hwdsl2/setup-ipsec-vpn/blob/master/README-zh-Hant.md) 和/或 [Headscale](https://github.com/hwdsl2/headscale-install/blob/main/README-zh-Hant.md)。
